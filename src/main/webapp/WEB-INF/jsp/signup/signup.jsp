 ...
 <div class="container">
  ...
  <form method="post" enctype="multipart/form-data" action="/animatch/signup/">
   ...
   <div class="form-group form-owner">
    ...
    <textarea name="pet-remarks" class="form-control" rows="10" placeholder="トリマーに伝えておきたいことを書いてください">
     <c:out value="${registForm.petRemarks}" />
    </textarea>
   ...
   <div class="form-group form-trimmer">
    ...
    <textarea name="course-info" class="form-control" rows="10" placeholder="サービスの詳細を書いてください">
     <c:out value="${registForm.courseInfo}" />
    </textarea>
   ...
   <div class="form-group form-trimmer">
    ...
    <textarea name="commitment" class="form-control" rows="10" placeholder="セールスポイントを書いてください">
     <c:out value="${registForm.commitment}" />
    </textarea>
