	                ...
	                <div class="col-md">
	                    ...
	                    <div class="row pt-4 pb-2">
	                        <div class="col-md text-center">
	                            ...
	                            <h2 class="font-weight-bold">お店専用</h2>
	                        </div>
	                    </div>
	                    ...
	                    <div class="row py-2 main-center-block is-show-search-trimmer">
	                        <div class="col-md main-center">
	                            ...
	                            <div class="row">
	                                <div class="col-md text-center">
	                                    <figure>
	                                        <a class="btn btn-primary btn-sm" href="/animatch/member/search/trimmer?tarPage=1&startPage=1" role="button">飼い主を探す<img src="/animatch/images/icon_search.png" alt="検索アイコン"></a>
	                                    </figure>
	                                </div>
	                            </div>
	                        </div>
	                    ...
	                    <div class="row pt-2 pb-4 main-center-block is-show-dmessage">
	                        <div class="col-md main-center">
	                            ...
	                            <div class="row">
	                                <div class="col-md text-center">
	                                    <figure>
	                                        <a class="btn btn-primary btn-sm" href="/animatch/member/dmessage/list" role="button">ダイレクトメッセージ<img src="/animatch/images/icon_direct_message.png" alt="ダイレクトメッセージアイコン"></a>
	                                    </figure>
	                                </div>
	                            </div>
	                        </div>
	                ...
	                <div class="col-md">
	                    ...
	                    <div class="row pt-4 pb-2">
	                        <div class="col-md text-center">
	                            ...
	                            <h2 class="font-weight-bold">飼い主専用</h2>
	                        </div>
	                    </div>
	                    ...
	                    <div class="row py-2 main-center-block is-show-search-owner">
	                        <div class="col-md main-center">
	                            ...
	                            <div class="row">
	                                <div class="col-md text-center">
	                                    <figure>
	                                        <a class="btn btn-primary btn-sm" href="/animatch/member/search/owner?tarPage=1&startPage=1" role="button">お店を探す<img src="/animatch/images/icon_search.png" alt="検索アイコン"></a>
	                                    </figure>
	                                </div>
	                            </div>
	                        </div>
