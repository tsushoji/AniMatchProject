     ...
     <div class="row py-2 main-center-block is-show-search-trimmer">
      <div class="col-md main-center">
       ...
       <div class="row">
        <div class="col-md text-center">
         <figure>
          <a class="btn btn-primary btn-sm" href="/animatch/member/search/trimmer" role="button">
           飼い主を探す
     ...
     <div class="row py-2 main-center-block is-show-search-owner">
      <div class="col-md main-center">
       ...
       <div class="row">
        <div class="col-md text-center">
         <figure>
          <a class="btn btn-primary btn-sm" href="/animatch/member/search/owner" role="button">
           お店を探す
           <img src="/animatch/images/icon_search.png" alt="検索アイコン">
          </a>
         </figure>
