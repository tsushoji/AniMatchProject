				...
				<c:if test="${not empty trimmerInfo and searchDetailTypeId == firstTypeKeyInitEnd}">
		            ...
		            <div class="row my-1 mx-auto">
		                ...
		                <div class="col-md-6 main-search-right">
		                    ...
		                    <h3 class="mt-2"><c:out value="${trimmerInfo.storeName}"/></h3>

		                    <h6 class="mt-3">都道府県市町村&#058;</h6>

		                    <p class="mt-1 pb-2 main-search-right-underline"><c:out value="${trimmerInfo.streetAddress}"/></p>

		                    <h6 class="mt-2">従業員数&ndash;人&#058;</h6>

		                    <p class="mt-1 pb-2 main-search-right-underline"><c:out value="${trimmerInfo.storeEmployeesNumber}"/></p>
							...
							<div class="pb-2 main-search-right-underline">
								<c:if test="${not empty trimmerInfo.trimmerInfoBusinessHoursList}">
									<c:forEach items="${trimmerInfo.trimmerInfoBusinessHoursList}" var="trimmerInfoBusinessHours">
										<p class="mb-0"><c:out value="${trimmerInfoBusinessHours.displayBusinessHours}"/>&ndash;<c:out value="${trimmerInfoBusinessHours.displayStartBusinessTime}"/>&sim;<c:out value="${trimmerInfoBusinessHours.displayEndBusinessTime}"/></p>
										<p class="mt-0">
				...
				<c:if test="${not empty ownerInfo and searchDetailTypeId == secondTypeKeyInitEnd}">
					...
					<div class="row my-1 mx-auto">
		                ...
		                <div class="col-md-6 main-search-right">
		                    ...
		                    <h3 class="mt-2"><c:out value="${ownerInfo.petNickName}"/></h3>

		                    <h6 class="mt-3">都道府県市町村&#058;</h6>

		                    <p class="mt-1 pb-2 main-search-right-underline"><c:out value="${ownerInfo.streetAddress}"/></p>

		                    <h6 class="mt-2">ペットの性別&#058;</h6>

		                    <p class="mt-1 pb-2 main-search-right-underline"><c:out value="${ownerInfo.petSex}"/></p>

		                    <h6 class="mt-2">ペットの種別&#058;</h6>

		                    <p class="mt-1 pb-2 main-search-right-underline"><c:out value="${ownerInfo.petType}"/></p>

		                    <h6 class="mt-2">ペットの体重&ndash;&#13199;&#058;</h6>

		                    <p class="mt-1 pb-2 main-search-right-underline"><c:out value="${ownerInfo.petWeight}"/></p>
